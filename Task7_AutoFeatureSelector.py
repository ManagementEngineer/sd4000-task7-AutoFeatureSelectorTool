...
def chi_squared_selector(X, y, num_feats):
    ...
    # chi_support = pd.DataFrame(topfeatures.scores_)
    # chi_feature = pd.DataFrame(X.columns)
...
def autoFeatureSelector(dataset_path, methods=['pearson', 'chi-square', 'rfe', 'log-reg', 'rf', 'lgbm']):
    # Parameters
